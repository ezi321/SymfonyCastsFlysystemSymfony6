 ...
 */
class DbUserRepository extends ServiceEntityRepository implements PasswordUpgraderInterface
{
    ...
    public function add(DbUser $entity, bool $flush = false): void
    {
    ...
    public function remove(DbUser $entity, bool $flush = false): void
    {
